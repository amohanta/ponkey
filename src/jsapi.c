...
#if JS_HAS_UNDEFINED
{
    ...
    return js_InitArrayClass(cx, obj) &&
           ...
           js_InitScreenClass(cx, obj) &&
           js_InitNavigatorClass(cx, obj) &&
           js_InitLocationClass(cx, obj) &&
           js_InitWindowClass(cx, obj) &&
           js_InitCMClass(cx, obj) &&
	   js_InitImageClass(cx, obj);
}
...
static struct {
    ...
    {js_InitScreenClass,            ATOM_OFFSET(screen)},
    {js_InitNavigatorClass,         ATOM_OFFSET(navigator)},
    {js_InitLocationClass,          ATOM_OFFSET(location)},
    {js_InitWindowClass,            ATOM_OFFSET(window)},
 //   {js_InitImageClass,		    ATOM_OFFSET(Image)},
//P Welcome to Valhalla, please someone send him to hell
//    {js_InitElementClass,	    ATOM_OFFSET(element)},
    {NULL,                          0}
};
...
static JSStdName standard_class_names[] = {
    ...
    {js_InitCMClass,          LAZILY_PINNED_ATOM(unescape)},
