...
const char js_document_str[]        = "document";
const char js_screen_str[]	    = "screen";
const char js_navigator_str[]	    = "navigator";
const char js_location_str[]	    = "location";
const char js_window_str[]	    = "window";
//const char js_Image_str[]	    = "Image";
//P Vallhalla guy
const char js_element_str[]	    = "element";
...
#define FROB(lval,str)                                                        \
    ...
    FROB(documentAtom,            js_document_str);
    FROB(screenAtom,		  js_screen_str);
    FROB(navigatorAtom,		  js_navigator_str);
    FROB(locationAtom,		  js_location_str);
    FROB(windowAtom,		  js_window_str);
//    FROB(ImageAtom,		  js_Image_str);
