...
extern const char   js_xml_str[];
extern const char   js_document_str[];
extern const char   js_screen_str[];
extern const char   js_navigator_str[];
extern const char   js_location_str[];
extern const char   js_window_str[];	
//extern const char   js_Image_str[];
//P Vallhalla guy
extern const char   js_element_str[];
